...
/*   Updated: 2025/01/18 23:45:14 by jcologne         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void data_fill(t_fractal *fractal)
{
	...
	fractal->image_definition = 84;
	fractal->shift_x = 0.0;
	fractal->shift_y = 0.0;
	fractal->zoom = 1.0;
	fractal->palette_size = 5;
	fractal->palette = (int[]){0x0000FF, 0x00FF00, 0xFF0000, 0xFFFF00, 0xFF00FF};
}
...
void	data_init(t_fractal *fractal)
{
	...
	fractal->img.pixel_pointer = mlx_get_data_addr(fractal->img.img_pointer, 
																&fractal->img.bpp,
